...
public class EllipsePanel extends AutoPanel {
    ...
    public EllipsePanel(XSLFAutoShape e) {
        ...
        setBounds((int) (r.getX() - l / 2 - 5), (int) (r.getY() - l / 2 - 5), (int) (r.getWidth() + l + 10), (int) (r.getHeight() + l + 10));
    }
    ...
    public boolean contains(Point p) {
        if (p == null)
            return false;
        Ellipse2D.Double e = (Ellipse2D.Double) auto, in = new Ellipse2D.Double(e.x + 5, e.y + 5, e.width - 10, e.height - 10),
