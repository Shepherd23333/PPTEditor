...
public class RectanglePanel extends AutoShapePanel {
    public RectanglePanel(XSLFAutoShape r) {
        ...
        setBounds((int) (re.getX() - l / 2 - 5), (int) (re.getY() - l / 2 - 5), (int) (re.getWidth() + l + 10),
                (int) (re.getHeight() + l + 10));
    }
    ...
    public boolean contains(Point p) {
        if (p == null)
            return false;
        Rectangle2D.Double r = (Rectangle2D.Double) auto,
                in = new Rectangle2D.Double(r.x + 5, r.y + 5, r.width - 10, r.height - 10),
